...
namespace Halcyon.Cms.Lib
{
    public class SWCmsConstants
    {
        ...
        public class AuthConfiguration
        {
            ...
            public const string AuthTokenIssuer = "Halcyon";
            public const string ConnectionString = @"Server=115.77.190.113,4444;Database=stag_halcyon_io;UID=sa;Pwd=sqlP@ssw0rd;MultipleActiveResultSets=true";
        ...
        public class JWTSettings
        {
            ...
            public const string SECRET_KEY = "halcyon-secret-key";
            // MINUTES
        }
